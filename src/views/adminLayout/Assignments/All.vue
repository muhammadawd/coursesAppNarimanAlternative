                ...
                <div class="dashboard_container">
                    <div class="row">
                        <div class="col-12 pt-3">
                            <h2 class="font-weight-bold fun_font text-center">{{$t('all_assignments')}}</h2>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-left ">{{$t('all_sent_students')}}</th>
                                    ...
                                    <td>
                                        <div class="btn-group direction-inverse">
                                            <button class="btn custom_btn btn-warning-light"
                                                    v-if="$helper.hasAccessPermission('show-student-assignment')"
