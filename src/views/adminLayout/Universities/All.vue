                            ...
                            <ul>
                                <li class="list-inline-item">
                                    <button class="btn btn-danger-light"
                                            v-if="$helper.hasAccessPermission('create-university')"
                                            @click="$router.push({name:'add_university'})">
                                        <i class="ti-plus"></i>
                                        {{$t('add')}}
                                    </button>
                                </li>
                                ...
                                <tr v-for="(category , index) in categories" :key="index">
                                    ...
                                    <td>
                                        <div class="btn-group direction-inverse">
                                            <button class="btn custom_btn btn-primary-light" v-if="$helper.hasAccessPermission('delete-university')"
                                                    @click="deleteCategory(category.id)">
                                                {{$t('delete')}}
                                            </button>
                                            <button class="btn custom_btn btn-success-light" v-if="$helper.hasAccessPermission('update-university')"
                                                    @click="$router.push({name:'edit_university',params:{id:category.id}})">
                                                {{$t('edit')}}
                                            </button>
                                        </div>
                                    </td>
